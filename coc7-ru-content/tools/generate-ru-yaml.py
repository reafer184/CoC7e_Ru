...
SKILLS = {
 ...
 "Art/Craft (Acting)": "Искусство/ремесло (актёрская игра)",
 "Art/Craft (Any)": "Искусство/ремесло (любое)",
 "Art/Craft (Fine Art)": "Искусство/ремесло (живопись)",
 ...
 "Dodge": "Уклонение",
 "Drive Auto": "Вождение автомобиля",
 "Drive Carriage": "Вождение экипажа",
 "Drive Horse / Oxen": "Вождение конной упряжки",
 "Drive Wagon / Coach": "Вождение повозки или дилижанса",
 "Electrical Repair": "Электрика",
 "Electronics": "Электроника",
 "Empire": "Империя",
 "Fast Talk": "Красноречие",
 ...
 "Jump": "Прыжки",
 "Language (Any)": "Язык (иностранный)",
 "Language (Own)": "Язык (родной)",
 "Language (Czech)": "Язык (чешский)",
 "Language (Dutch)": "Язык (голландский)",
 ...
 "Law": "Юриспруденция",
 "Library Use": "Работа в библиотеке",
 "Listen": "Слух",
 "Locksmith": "Взлом",
 "Lore (Any)": "Знание (любое)",
 "Mechanical Repair": "Механика",
 "Medicine": "Медицина",
 "Natural World": "Естествознание",
 "Navigate": "Ориентирование",
 "Occult": "Оккультизм",
 "Operate Heavy Machinery": "Управление тяжёлыми машинами",
 "Persuade": "Убеждение",
 ...
 "Science (Engineering)": "Наука (инженерия)",
...
SPELL_DESC = ("<p>Заставляет другого человека увидеть кошмар.</p>"
 "<p>Чародей тратит некоторое количество пунктов магии и теряет [[/r 1D3 - 1]] пунктов рассудка. "
 ...
 "на одну минуту за каждые шесть потраченных пунктов магии.</p><p></p>")
SPELL_PROMPTS = {
 "The target is awake": "Жертва не спит",
 "Number of magic points you are spending": "Сколько пунктов магии вы тратите",
 "Others that know the spell": "Другие, знающие заклинание",
 "Magic points": "Пункты магии",
